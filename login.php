...
<body>
    <div class="d-flex align-items-center py-6 h-100 ">
        <main class="w-100 m-auto form-container bg-white rounded-3 p-5">
            <form action="login.php" method="POST" class="needs-validation">
                ...
                <div class="row">
                    <div class="col-md-6 text-center">
                        <p><a href="registro.php" class="link-secondary link-offset-2 link-opacity-25 link-opacity-100-hover">Registre-se</a></p>
                    </div>
                    <div class="col-md-6 text-center">
                        <p><a href="recuperar_senha.php" class="link-secondary link-offset-2 link-opacity-25 link-opacity-100-hover">Esqueci a Senha</a></p>
                    </div>
                </div>
