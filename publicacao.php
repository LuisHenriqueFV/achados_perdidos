...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    // Pesquisa objetos encontrados
    if ($categoria === "MostrarTodos" || empty($categoria)) {
...
<body>
    <main>
        ...
        <div id="conteudo" class="container">
            <div class="forms">
                <form action="nome_da_pagina.php" method="GET">
                    <div class="mb-3 input-group">
                        <input type="text" name="pesquisar" class="form-control"
                            placeholder="Pesquisar objeto" autocomplete="off">
            ...
            <div class="conteudo">
                <?php if ($objetosEncontrados || $objetosPerdidos): ?>
                    <?php if (empty($objetosEncontrados) && empty($objetosPerdidos)): ?>
